...
/** Matches Sophia's generated-image sentinel: ![generated](file:{id}) */
const GENERATED_IMAGE_RE = /^!\[generated\]\(file:(\d+)\)$/;
...
export function renderAnswer(text: string): ReactNode[] {
  ...
  for (const raw of lines) {
    ...
    const generatedImage = line.match(GENERATED_IMAGE_RE);
    ...
    if (generatedImage) {
      ...
      out.push(
        <img
          ...
          src={`/api/files/${generatedImage[1]}/raw`}
          alt="Generated by Sophia"
        />,
      );
      key += 1;
    } else if (heading) {
